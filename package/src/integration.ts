...
export const optionsSchema = z.object({
  ...
  openGraph: z.object({
    ...
    /**
     * Open Graph meta tags for the news page.
     */
    news: openGraphOptionsSchema,
  }),
  /**
...
export default function integration(options: z.infer<typeof optionsSchema>): AstroIntegration {
  const validatedOptions = optionsSchema.parse(options);
    ...
    export const themeColor = ${JSON.stringify(validatedOptions.themeColor ?? '#17c021')};
    ...
    export const openGraph = {
      ...
      news: ${JSON.stringify(validatedOptions.openGraph.news)},
    };
